...
mondayBtn.addEventListener('click', () => fetchWeatherForDay('Monday'));
tuesdayBtn.addEventListener('click', () => fetchWeatherForDay('Tuesday'));
wednesdayBtn.addEventListener('click', () => fetchWeatherForDay('Wednesday'));
thursdayBtn.addEventListener('click', () => fetchWeatherForDay('Thursday'));
fridayBtn.addEventListener('click', () => fetchWeatherForDay('Friday'));

function fetchWeatherForDay(day) {
    const weatherContainer = document.getElementById('weather-data');
    weatherContainer.innerHTML = `<h2>${day} 날씨</h2>`;
